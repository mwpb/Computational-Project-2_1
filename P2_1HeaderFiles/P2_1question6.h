...
int question6(int a, double BBN, int b)

{
    
    int q,r,x,i,m,s,X,Y,W,Z,d,e,f,A,B,rem,U,BB,ans,l,L,DD,ZZZ,YYY,XX;
    double EE;
    gsl_vector*v;
    FILE*out=fopen("P2_1Output/question9.txt","w");
